...
@vertex fn vertexMain(
    ...
    var vertexToDraw = line.startPoint * -(cubeVertex.z - 1)/2 + line.endPoint * (cubeVertex.z + 1)/2 + vertexOffset;
...
@fragment fn fragmentMain(
    ...
    output.colour = vec4f(input.colour, 1);

    return output;
}
`
});
const shaderName = "lines3dRenderShader";
export const lines3dRenderShaderInfo = {
    loadPipeline: () => {
