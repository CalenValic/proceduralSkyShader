...
struct vertexShaderOutput {
    ...
    @location(3) worldSpacePosition: vec3f,
    @location(4) viewSpacePosition: vec3f
}
...
@fragment fn fragmentMain(
    ...
    output.colour = mix(colour, fog.colour, fogAmount);
    
    return output;
}
`
});
const shaderName = "transparentEntityRenderShader";
export const transparentEntityRenderShaderInfo = {
    loadPipeline: () => {
    ...
    render: (commandEncoder, loadOp, properties) => {
        ...
        for (var shaderFlagID in layer.meshInstances) {
            ...
            if (currentShaderFlag == (ShaderFlags.TRANSPARENT)) {
